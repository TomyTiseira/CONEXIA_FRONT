      ...
      if (target) {
        try {
          ...
          setToast({
            ...
            message: data.message || "Acción realizada.",
          });
        } catch {
          // ignore parse error
        } finally {
  ...
  useEffect(() => {
    const applyFilters = async () => {
      ...
      const hasActiveFilters =
        ...
        (Array.isArray(pendingFilters.category) &&
          pendingFilters.category.length > 0 &&
          !isAll(pendingFilters.category)) ||
        (Array.isArray(pendingFilters.skills) &&
          pendingFilters.skills.length > 0 &&
          !isAll(pendingFilters.skills)) ||
        (Array.isArray(pendingFilters.collaboration) &&
          pendingFilters.collaboration.length > 0 &&
          !isAll(pendingFilters.collaboration)) ||
        (Array.isArray(pendingFilters.contract) &&
          pendingFilters.contract.length > 0 &&
          !isAll(pendingFilters.contract));
    ...
    <>
      ...
      <div className="min-h-[calc(100vh-64px)] bg-[#f3f9f8] py-8 px-6 md:px-6 pb-20 md:pb-8 flex flex-col items-center">
        <div className="w-full max-w-7xl flex flex-col gap-6">
          ...
          {roleName === ROLES.USER && <UpgradePlanButton context="projects" />}

          {/* Header: título, buscador y botón */}
          <div className="flex flex-col md:flex-row md:items-center md:gap-6 mb-2 w-full">
            <div className="flex flex-col md:flex-row md:items-center w-full">
              <h1 className="text-3xl md:text-4xl font-extrabold text-conexia-green-dark tracking-tight leading-tight bg-white rounded-lg px-6 py-3 shadow-sm w-full md:w-[320px] text-center md:text-left mb-4 md:mb-0">
                Proyectos
              </h1>
            ...
            <aside className="w-full md:w-[320px] flex-shrink-0">
              <div className="bg-white rounded-xl shadow p-5 mb-4">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-bold text-conexia-green">
                    Filtrar por
                  </h2>
                  <button
                      ...
                      <div className="mt-8">
                        ...
                        <>
                          ...
                          <div className="mb-4 flex flex-col items-center w-full">
                            <div className="text-lg xs:text-xl font-semibold text-gray-800 text-center">
                              Proyectos recomendados para ti
                            </div>
                            <div className="text-conexia-green text-sm xs:text-base font-medium text-center mt-1">
                              {recommendations?.length || 0} proyecto
                        ...
                        {isLoadingAllProjects ? (
                          ...
                          <div className="min-h-[900px] flex flex-col">
                            <div className="flex-1">
                              <ProjectList
                                projects={allProjectsList.slice(
                                  (page - 1) * pageSize,
                                  page * pageSize,
                                )}
                            ...
                            <div className="mt-8 flex justify-center">
                              <Pagination
                                ...
                                hasNextPage={
                                  allProjectsList.length > page * pageSize
                                }
