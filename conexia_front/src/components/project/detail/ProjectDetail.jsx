            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <p className="text-sm text-gray-900">
                  {getApplicationTypesText(
                    role.applicationTypes,
                ...
                {role.evaluation.link && (
                  <p className="text-blue-700 text-xs mb-1 break-all overflow-wrap-anywhere">
                    ...
                    <a
                      ...
                      className="hover:underline ml-1 inline-block max-w-full"
                    >
                      {role.evaluation.link}
                    </a>
                  </p>
...
${messageText.trim()}`;
  ...
  if (!project)
    return (
      <div className="min-h-screen flex items-center justify-center text-conexia-green">
  ...
  const isOwner =
    user &&
    project &&
    (String(user.id) === String(project.ownerId) || project.isOwner);
  ...
  const contractTypes = Array.isArray(project.contractType)
    ? project.contractType
    : project.contractType
      ? [project.contractType]
      : [];
  const collaborationTypes = Array.isArray(project.collaborationType)
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-[calc(100vh-64px)] relative py-8 px-6 md:px-6 flex flex-col items-center overflow-x-hidden pb-20 md:pb-8 bg-[#f3f9f8]">
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white border rounded-lg shadow-lg z-40">
                  {roleName === ROLES.ADMIN || roleName === ROLES.MODERATOR ? (
                    <button
                      ...
                      style={{
                        boxShadow: "0 2px 8px 0 rgba(167, 119, 119, 0.06)",
                      }}
                      onClick={() => {
                        setMenuOpen(false);
                    ...
                    >
                      <span className="flex items-center gap-2">
                        <svg
                          ...
                          className="h-6 w-6 text-conexia-green"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (project.hasReported) {
                          setToast({
                            type: "warning",
                            message: "Ya has reportado este proyecto",
                            isVisible: true,
                          });
                          return;
                        }
          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="flex flex-col items-center md:items-start w-full md:w-56">
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                >
                  <span className="text-conexia-green font-semibold text-sm break-words hover:underline">
                    {ownerName}
                  </span>
            ...
            <div className="flex-1 flex flex-col gap-4 min-w-0">
              <div className="flex items-center justify-between relative">
                <h1 className="text-3xl font-bold text-conexia-green break-words whitespace-pre-line break-all word-break-break-all max-w-[90vw] md:max-w-[80%] truncate">
              ...
              <div className="flex flex-wrap gap-2 mb-1">
                ...
                {collaborationTypes.length > 0 &&
                  collaborationTypes.map((type) => (
                    <span
                      key={type}
                      className="bg-conexia-green/10 text-conexia-green px-3 py-1 rounded-full text-xs font-semibold"
                    >
                      {type}
                    </span>
                  ))}
              ...
              <div>
                ...
                <div className="text-base break-words whitespace-pre-line text-gray-700 bg-gray-50 rounded p-3 border border-gray-100">
              ...
              {project.location && (
                <div>
                  ...
                  <div className="text-base break-words text-gray-700 bg-gray-50 rounded p-3 border border-gray-100">
                    {project.location}
                  </div>
                </div>
              )}
          ...
          {isOwner && (
            <div className="mt-6 flex flex-col md:flex-row items-end gap-2 justify-end">
              <button
                ...
                onClick={() =>
                  router.push(`/project/${projectId}/postulations`)
                }
              >
                Ver postulaciones
              </button>
            ...
            roleName !== ROLES.MODERATOR && (
              <div className="mt-8 w-full">
                ...
                {messageSent ? (
                  ...
                  <div
                    className="bg-gray-50 border border-gray-100 rounded-lg p-4 flex flex-row items-center gap-2 shadow-sm min-h-[96px]"
                    style={{ boxShadow: "0 2px 8px 0 rgba(0,0,0,0.03)" }}
                  >
                    <div className="flex-1 w-full flex flex-col">
                      <label
                        htmlFor="mensajeCreador"
                        className="flex items-center gap-1 font-semibold text-conexia-green mb-1 text-[11px] md:text-sm"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          ...
                          strokeWidth={1.5}
                          stroke="currentColor"
                          className="w-3 h-3 md:w-5 md:h-5 text-conexia-green"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        ...
                        <span className="truncate">
                          Envía un mensaje al creador del proyecto
                        </span>
                      </label>
          ...
          <div className="mt-8 flex justify-start">
            <BackButton
              onClick={() => {
                ...
                const fromReportsProjectId = searchParams.get(
                  "fromReportsProjectId",
                );
          ...
          <ReportProjectModal
            ...
            onSubmit={async (data) => {
              ...
              try {
                ...
                setToast({
                  type: "success",
                  message: "Proyecto reportado con éxito.",
                  isVisible: true,
                });
                setAlreadyReported(true);
              } catch (err) {
                const alreadyReportedRegex =
                  /Project with id \d+ has already been reported by user \d+/;
                const conflict =
                  (err.message &&
                ...
                if (conflict) {
                  ...
                  setToast({
                    type: "error",
                    message:
                      "Error al reportar el proyecto. Inténtalo más tarde.",
                    isVisible: true,
                  });
                }
              } finally {
