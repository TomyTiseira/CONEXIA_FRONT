...
export default function ConnectionRequestCard({ name, profession, image, requestId, onIgnore, onAccepted }) {
    ...
    >
      ...
      <div className="flex flex-row items-center flex-1 min-w-0">
        ...
        <div className="flex flex-col justify-center min-w-0 ml-3">
          <div className="font-semibold text-conexia-green text-base sm:text-lg truncate leading-tight sm:leading-[1.5]">{name}</div>
