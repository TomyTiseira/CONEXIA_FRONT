...
export default function QuotationModal({
  ...
  const { acceptHiring, rejectHiring, cancelHiring, negotiateHiring, loading } =
    useServiceHirings();
  ...
  const getActionConfig = (action) => {
    const configs = {
      accept: {
        ...
        description:
          "Al aceptar esta cotización, confirmas que estás de acuerdo con el precio y tiempo estimado. El proveedor podrá comenzar a trabajar en tu solicitud.",
      ...
      reject: {
        ...
        description:
          "Al rechazar esta cotización, la solicitud se marcará como rechazada y no podrás volver a aceptarla. El proveedor será notificado de tu decisión.",
      ...
      negotiate: {
        ...
        description:
          "Al iniciar una negociación, el proveedor será notificado que deseas discutir los términos de la cotización. Podrás comunicarte directamente para llegar a un acuerdo.",
  ...
  const hasQuotation = Boolean(
    (hiring.quotedPrice ||
      (hiring.deliverables && hiring.deliverables.length > 0)) &&
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              {confirmAction === "negotiate" && (
                <div className="mt-4">
                  <label
                    htmlFor="negotiationDescription"
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setNegotiationDescription(e.target.value.slice(0, 1000))
                    }
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium text-gray-900 break-words overflow-wrap-anywhere line-clamp-2 leading-tight">
                ...
                <div>
                  ...
                  <p className="font-medium text-conexia-green">
                    ...
                    {hiring.service?.timeUnit
                      ? ` por ${getUnitLabel(hiring.service.timeUnit)}`
                      : ""}
                  </p>
                </div>
                <div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-red-600">
                          Esta cotización ha expirado. Debes cancelar la
                          solicitud para poder volver a pedir una nueva
                          cotización.
                        </p>
                        <div className="mt-4">
                          <Button
                      ...
                      <div className="mt-4 bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p
                              className={`text-lg font-bold ${getVigencyStatus(hiring).className}`}
                            >
                              {getVigencyStatus(hiring).text}
                            </p>
                          </div>
                          <div className="text-sm text-gray-500">
                            Válida por {hiring.quotationValidityDays}{" "}
                            {hiring.quotationValidityDays === 1
                              ? "día"
                              : "días"}
                          </div>
                        </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-600">
                ...
                <br />
                Puedes contactar al proveedor directamente o gestionar esta
                solicitud desde tus acciones disponibles.
              </p>
            </div>
          </div>
