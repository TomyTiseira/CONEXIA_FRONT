              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <span
                        className={`px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap ${getStatusColor(hiring.status?.code)}`}
                      >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-red-600">
                          Esta cotización ha expirado. La única acción
                          disponible es cancelar la solicitud para poder volver
                          a cotizar este servicio.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="mt-4 bg-gray-50 rounded-lg p-3 border border-gray-200">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p
                              className={`text-base font-bold ${getVigencyStatus(hiring).className}`}
                            >
