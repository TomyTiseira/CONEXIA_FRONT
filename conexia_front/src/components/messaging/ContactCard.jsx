...
export default function ContactCard({
  ...
  if (professionDisplay.length > maxProfessionLength) {
    professionDisplay =
      professionDisplay.slice(0, maxProfessionLength - 3) + "...";
  }

  return (
    <div
      className="flex items-center gap-3 px-3 py-2.5 w-full cursor-pointer hover:bg-conexia-green/10"
      onClick={onClick}
    >
      ...
      <div className="flex-1 min-w-0 leading-tight">
        ...
        <div className="text-[13px] text-gray-600 truncate" title={description}>
          {professionDisplay}
        </div>
      </div>
    </div>
