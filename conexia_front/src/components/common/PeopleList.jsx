        ...
        >
          ...
          {person.coverPicture ? (
            <div className="w-full h-16 bg-center bg-cover relative rounded-t-2xl overflow-hidden">
              <Image
                src={
                  person.coverPicture.startsWith("http")
                    ? person.coverPicture
                    : `${config.IMAGE_URL}/${person.coverPicture}`
                }
                alt="Portada"
                fill
          ...
          >
                ...
                src={
                  person.profilePicture
                    ? person.profilePicture.startsWith("http")
                      ? person.profilePicture
                      : `${config.IMAGE_URL}/${person.profilePicture}`
            ...
            <h3
              className="font-bold text-conexia-green text-center leading-tight mt-3 mb-1 text-base"
              style={{ marginTop: 12 }}
            >
